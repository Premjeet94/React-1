...
const ResCard = ({res}) => {
    const {name,cuisines,costForTwo,slugs,lastMileTravel,cloudinaryImageId} = res.data;
  return (
  ...
  return (
    <div>
      <div className="flex gap-5 justify-center h-10 w-full">
        <input placeholder="Search Your Favourite Restaurant" className="w-80 outline-0 border font-medium rounded px-6 py-2"></input>
        <button className="bg-amber-300 w-30 rounded active:scale-90 hover:cursor-pointer">Search</button>
      </div>
